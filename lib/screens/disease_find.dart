...
import 'package:farmogram/screens/disease_result..dart';
...
class _DiseaseDetectionScreenState extends State<DiseaseDetectionScreen> {
  ...
  Future<void> _uploadImage() async {
    ...
    const String apiKey =
        'D757t4FwtmUjalzWxC5qqYLXezFkb6umUT1zyhGaRnaHypZxDm'; // Replace with your actual API key
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      if (result['disease'] != null) {
        var firstSuggestion = result['disease']['suggestions'][0];

        setState(() {
          _disease = firstSuggestion['name'];
